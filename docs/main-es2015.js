...
let AuthService = class AuthService {
    ...
    createNewUser(email, password) {
        return new Promise((resolve, reject) => {
            this.http.post(url + 'auth/signup', { email: email, password: password })
                .subscribe(() => {
    ...
    login(email, password) {
        return new Promise((resolve, reject) => {
            this.http.post(url + 'auth/login', { email: email, password: password })
                .subscribe((authData) => {
...
let StuffService = class StuffService {
    ...
    getStuff() {
        this.http.get(url + 'stuff').subscribe((stuff) => {
            if (stuff) {
                this.stuff = stuff;
                this.emitStuff();
            }
    ...
    getThingById(id) {
        return new Promise((resolve, reject) => {
            this.http.get(url + 'stuff/' + id).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    createNewThing(thing) {
        return new Promise((resolve, reject) => {
            this.http.post(url + 'stuff', thing).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    createNewThingWithFile(thing, image) {
        return new Promise((resolve, reject) => {
            ...
            this.http.post(url + 'stuff', thingData).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    modifyThing(id, thing) {
        return new Promise((resolve, reject) => {
            this.http.put(url + 'stuff/' + id, thing).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    modifyThingWithFile(id, thing, image) {
        return new Promise((resolve, reject) => {
            ...
            this.http.put(url + 'stuff/' + id, thingData).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
    ...
    deleteThing(id) {
        return new Promise((resolve, reject) => {
            this.http.delete(url + 'stuff/' + id).subscribe((response) => {
                resolve(response);
            }, (error) => {
                reject(error);
            });
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/OC/DW/P6/frontend/src/main.ts */"./src/main.ts");
